...
namespace LMB.Controllers
{
    public class RawDatasController : Controller
    {
        ...
        public ActionResult RowData(HttpPostedFileBase uploadfile)
        {
            ...
            if (ModelState.IsValid)
            {
                if (uploadfile != null && uploadfile.ContentLength > 0)
                {
                    ...
                    foreach (DataRow data in result.Tables[0].Rows)
                    {
                        ...
                        inspectiondaily.NumInspection = "1";
                        ...
                        catch (Exception ex)
                        {
                            ...
                            return RedirectToAction("Index", "RawDatas");
            ...
            return RedirectToAction("Index", "RowData");
            //return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Create([Bind(Include = "IDRawData,FileNo,District,County,Control,Section,Milepnt,StrNo,DupRtOver,RtStrFunc,Blanks1,RtDesign,RtBusSfx,RtSystem,RtNo,RtDir,BRefMrk,BRefMkSfx,BRfMkign,BRfMkDispl,PlaceCode,FeatXed,CritBdg,MiPtDatePr,AMiPtDateInt,Blanks2,FacCarried,Location,RtMinVrtClear,OLD16Latitude,OLD17Longitude,DetourLgth,Toll,Custodian,Owner,MaintSect,ProjType,CSJWhnBlt,FuncClass,YrBuilt,LanesOn,LanesUnder,AADT,AADTYear,DesignLoad,ApprWidth,Median,Skew,StrFlared,TrfSafeFeat,HistSignif,NavControls,NavHrzClear,OperStatus,LoadType,Load1000lb,ServOnUnder,MnSpanTy,MjAprSpTy,MnAprSpTy,CulvType,TunnelTy,SubstrMSpan,SubMjAprSp,SubMnAprSp,NoMSpan,NoMjAprSp,NoMnAprSp,TotalNoSpans,TotHrzClear,MaxSpLgth,StrLgth,LtSdwalk,RtSdwalk,RdwyWidth,DeckWidth,VrtClrOver,VrtClrRefFeat,VrtClrUnder,LatClrRefFeat,RtLatClear,LtLatClear,Blanks3,DeckCond,SuperCond,SubstrCond,ChanProt,Culvert,OperRate,RdApprCond,InvRate,StrEval,DeckGeom,UClrVrtHrz,SafeLoadCap,WaterwayAdeq,ApprRdAlign,TyWrkRepl,LgthImprov,SpecFlags,FHWAResvd,CostImprov1,LastInspec,DesInspFreq,FracCritDet,UndwtrInspec,SpecialInspec,FracCritDate,UwtrInsDate,SpecInspDate,BdgImprCost,RdImprCost,TotProjCost,YrImprCostEst,BorderBdg,BorderBdgNo,DefHwyDesn,ParlStrDesn,DirofTraffic,TempStrDesn,NHS,OldFAU,FHWAResvd_105,YrReconstr,WidenCode,DeckTyMSp,MSpWrSurf,DeckMjAprSp,MjAprSpWrSrf,DkMnAprSp,MnAprSpWrSrf,AADTTruckPct,DesNatlNtwk,PierProtect,NBIBdgLgth,ScourCrit,FutureAADT,FutAADTYear,MnNavVrtClear,OrigCost,DefObs,SuffRate,XrefPrinRtID,XrfStrFncPRt,SuffRatFlag,ScourVuln,OvHtLoadDmg,Blanks4,XRfIRID,XRfIRStrFunc,Blanks5,DistUse,AIRControl,AIRSection,AIRMilept,AIRStrNo,AIRDuplOver,AIRStrFunct,AIRDesignation,AIRBusSfx,AIRHwySys,AIRHwyNo,AIRDir,CIRRefMrk,CIRRefMkSfx,CIRRfMkSign,CIRRfMkDispl,AIRHrzClear,AIRMnVrtClear,AIRBypsLgth,AIRToll,AIRFuncClass,AIRAADT,AIRAADTYr,AIRDefHwyDes,AIRParlStr,AIRTrafDir,AIRTempStr,AIRNHS,OldFAU_IR,AIRAADTTrkPct,AIRNatlNtwk,AIRFutAADT,AIRFAADTYr,Blanks6,FHWAStrEval,FHWADkGeom,FHWAUClrVrtHrz,BaseHwyNet,LRSInvRte,LRSSubRte,Blanks7,GPSLatitude,Blanks8,GPSLongitude,GPSColMeth,MethOperRate,MethInvRate,FedLand,Latitude,Longitude,AIRBaseHwyNet,AIRLRSInvRte,AIRLRSSubRte,Blanks9")] RawData rawData)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IDRawData,FileNo,District,County,Control,Section,Milepnt,StrNo,DupRtOver,RtStrFunc,Blanks1,RtDesign,RtBusSfx,RtSystem,RtNo,RtDir,BRefMrk,BRefMkSfx,BRfMkign,BRfMkDispl,PlaceCode,FeatXed,CritBdg,MiPtDatePr,AMiPtDateInt,Blanks2,FacCarried,Location,RtMinVrtClear,OLD16Latitude,OLD17Longitude,DetourLgth,Toll,Custodian,Owner,MaintSect,ProjType,CSJWhnBlt,FuncClass,YrBuilt,LanesOn,LanesUnder,AADT,AADTYear,DesignLoad,ApprWidth,Median,Skew,StrFlared,TrfSafeFeat,HistSignif,NavControls,NavHrzClear,OperStatus,LoadType,Load1000lb,ServOnUnder,MnSpanTy,MjAprSpTy,MnAprSpTy,CulvType,TunnelTy,SubstrMSpan,SubMjAprSp,SubMnAprSp,NoMSpan,NoMjAprSp,NoMnAprSp,TotalNoSpans,TotHrzClear,MaxSpLgth,StrLgth,LtSdwalk,RtSdwalk,RdwyWidth,DeckWidth,VrtClrOver,VrtClrRefFeat,VrtClrUnder,LatClrRefFeat,RtLatClear,LtLatClear,Blanks3,DeckCond,SuperCond,SubstrCond,ChanProt,Culvert,OperRate,RdApprCond,InvRate,StrEval,DeckGeom,UClrVrtHrz,SafeLoadCap,WaterwayAdeq,ApprRdAlign,TyWrkRepl,LgthImprov,SpecFlags,FHWAResvd,CostImprov1,LastInspec,DesInspFreq,FracCritDet,UndwtrInspec,SpecialInspec,FracCritDate,UwtrInsDate,SpecInspDate,BdgImprCost,RdImprCost,TotProjCost,YrImprCostEst,BorderBdg,BorderBdgNo,DefHwyDesn,ParlStrDesn,DirofTraffic,TempStrDesn,NHS,OldFAU,FHWAResvd_105,YrReconstr,WidenCode,DeckTyMSp,MSpWrSurf,DeckMjAprSp,MjAprSpWrSrf,DkMnAprSp,MnAprSpWrSrf,AADTTruckPct,DesNatlNtwk,PierProtect,NBIBdgLgth,ScourCrit,FutureAADT,FutAADTYear,MnNavVrtClear,OrigCost,DefObs,SuffRate,XrefPrinRtID,XrfStrFncPRt,SuffRatFlag,ScourVuln,OvHtLoadDmg,Blanks4,XRfIRID,XRfIRStrFunc,Blanks5,DistUse,AIRControl,AIRSection,AIRMilept,AIRStrNo,AIRDuplOver,AIRStrFunct,AIRDesignation,AIRBusSfx,AIRHwySys,AIRHwyNo,AIRDir,CIRRefMrk,CIRRefMkSfx,CIRRfMkSign,CIRRfMkDispl,AIRHrzClear,AIRMnVrtClear,AIRBypsLgth,AIRToll,AIRFuncClass,AIRAADT,AIRAADTYr,AIRDefHwyDes,AIRParlStr,AIRTrafDir,AIRTempStr,AIRNHS,OldFAU_IR,AIRAADTTrkPct,AIRNatlNtwk,AIRFutAADT,AIRFAADTYr,Blanks6,FHWAStrEval,FHWADkGeom,FHWAUClrVrtHrz,BaseHwyNet,LRSInvRte,LRSSubRte,Blanks7,GPSLatitude,Blanks8,GPSLongitude,GPSColMeth,MethOperRate,MethInvRate,FedLand,Latitude,Longitude,AIRBaseHwyNet,AIRLRSInvRte,AIRLRSSubRte,Blanks9")] RawData rawData)
        {
            if (ModelState.IsValid)
            {
