...
namespace LMB.Helpers
{
    public class UsersHelper : IDisposable
    {
        ...
        public static void CheckSuperUser()
        {
            ...
            if (userASP == null)
            {
                CreateUserASP(email,"Javier Penagos" ,"Admin", password);
                return;
            }
        ...
        public static void CreateUserASP(string email, string userName, string roleName)
        {
            var userManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(userContext));
        ...
        public static async Task PasswordRecovery(string email)
        {
            ...
            var user = db.UserDB.Where(tp => tp.UserName == email).FirstOrDefault();
            if (user == null)
            {
                return;
            }
            ...
            var subject = "LMB Password Recovery";
